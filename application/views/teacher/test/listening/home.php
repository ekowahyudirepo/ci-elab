	                        ...
	                        <table id="myTable" class="table table-bordered">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td>
	                                    	<?php echo $row->listening_test_name; ?>
	                                    	<br>
	                                    	<br>
	                                    	<a href="<?php echo base_url(); ?>teacher/test/listening_police/<?php echo $row->listening_test_id; ?>"><i class="ti-receipt"></i> Update Policy</a>	
	                                    </td>
	                                    ...
	                                    <td>
	                                    	...
	                                    	<?php elseif( $row->listening_test_status == 'finish' ): ?>
	                                    ...
	                                    <td align="center">
	                                    	<a href="<?php echo base_url(); ?>teacher/test/listening_question/<?php echo $row->listening_test_id; ?>" class="btn btn-primary"><i class="ti-eye"></i></a>
	                                    	<br>
	                                    ...
	                                    <td align="center">
	                                    	<a href="<?php echo base_url(); ?>teacher/test/listening_student/<?php echo $row->listening_test_id; ?>" class="btn btn-info"><i class="ti-eye"></i></a>
	                                    	<br>
	                                    	<span class="badge badge-info"><?php echo $this->db->group_by('student_id')->get_where('listening_answer', ['listening_test_id' => $row->listening_test_id])->num_rows(); ?> student</span>
	                                    </td>
	                                    <td align="center">
	                                    	<?php if( $this->db->get_where('listening_sub_test', ['listening_test_id' => $row->listening_test_id])->num_rows() ): ?>
	                                    		<?php if( $row->listening_test_status == 'new' ): ?>
		                                    		<a href="<?php echo base_url(); ?>teacher/test/listening_play/<?php echo $row->listening_test_id; ?>" class="btn btn-success"><i class="ti-control-play"></i></a>
		                                    	<?php endif; ?>
	                                    	<?php else: ?>
		                                    	<a href="<?php echo base_url(); ?>teacher/test/listening_del/<?php echo $row->listening_test_id; ?>" class="btn btn-danger"><i class="ti-trash"></i></a>
		                                    <?php endif; ?>
	                                    </td>
	                                </tr>
	                            <?php endforeach; ?>
...
<div id="create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>teacher/test/listening_add/<?php echo $this->uri->segment(4); ?>" method="post" novalidate> 
