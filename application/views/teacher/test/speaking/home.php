                    ...
                    <div class="card-body">
                    	...
                    	<div class="table-responsive">
	                        <table id="myTable" class="table table-bordered">
	                            ...
	                            <tbody>
	                            	<?php $no = 1; ?>
	                                <?php foreach($qw_speaking_test->result() as $row): ?>
	                                <tr>
	                                    <td align="center"><?php echo $no++;  ?></td>
	                                    <td>
	                                    	<?php echo $row->speaking_test_name; ?>
	                                    	<br>
	                                    	<br>
	                                    	<a href="<?php echo base_url(); ?>teacher/test/speaking_police/<?php echo $row->speaking_test_id; ?>"><i class="ti-receipt"></i> Update Policy</a>	
	                                    </td>
	                                    <td><?php echo $row->speaking_test_point_pass; ?></td>
	                                    <td>
	                                    	<?php echo tgl_f($row->speaking_test_start); ?> (start)<br><?php echo tgl_f($row->speaking_test_finish); ?> (finish)<br>
	                                    	<?php if( $row->speaking_test_status == 'pending' ): ?>
	                                    		<span class="badge badge-info">Pending</span>
	                                    	<?php elseif( $row->speaking_test_status == 'start' ): ?>
	                                    		<span class="badge badge-success">Start</span>
	                                    	<?php elseif( $row->speaking_test_status == 'finish' ): ?>
	                                    		<span class="badge badge-danger">Finish</span>
	                                    	<?php else: ?>
	                                    		<span class="badge badge-dark">New</span>
	                                    	<?php endif; ?>
	                                    </td>
	                                    <td><?php echo tgl_f($row->speaking_test_add); ?></td>
	                                    <td align="center">
	                                    	<a href="<?php echo base_url(); ?>teacher/test/speaking_question/<?php echo $row->speaking_test_id; ?>" class="btn btn-primary"><i class="ti-eye"></i></a>
	                                    	<br>
	                                    	<span class="badge badge-info"><?php echo $this->db->get_where('speaking_sub_test', ['speaking_test_id' => $row->speaking_test_id])->num_rows(); ?> question</span>
	                                    </td>
	                                    <td align="center">
	                                    	<a href="<?php echo base_url(); ?>teacher/test/speaking_student/<?php echo $row->speaking_test_id; ?>" class="btn btn-info"><i class="ti-eye"></i></a>
	                                    	<br>
	                                    	<span class="badge badge-info"><?php echo $this->db->group_by('student_id')->get_where('speaking_answer', ['speaking_test_id' => $row->speaking_test_id])->num_rows(); ?> student</span>
	                                    </td>
	                                    <td align="center">
	                                    	<?php if( $this->db->get_where('speaking_sub_test', ['speaking_test_id' => $row->speaking_test_id])->num_rows() ): ?>
	                                    		<?php if( $row->speaking_test_status == 'new' ): ?>
		                                    		<a href="<?php echo base_url(); ?>teacher/test/speaking_play/<?php echo $row->speaking_test_id; ?>" class="btn btn-success"><i class="ti-control-play"></i></a>
		                                    	<?php endif; ?>
	                                    	<?php else: ?>
		                                    	<a href="<?php echo base_url(); ?>teacher/test/speaking_del/<?php echo $row->speaking_test_id; ?>" class="btn btn-danger"><i class="ti-trash"></i></a>
		                                    <?php endif; ?>
	                                    </td>
	                                </tr>
	                            <?php endforeach; ?>
...
<div id="create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>teacher/test/speaking_add/<?php echo $this->uri->segment(4); ?>" method="post" novalidate> 
