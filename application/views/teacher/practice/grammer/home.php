	                        ...
	                        <table id="myTable" class="table table-bordered">
	                            ...
	                            <tbody>
	                                ...
	                                <tr>
	                                    ...
	                                    <td align="center">
	                                    	<a href="<?php echo base_url(); ?>teacher/practice/grammer_question/<?php echo $row->grammer_test_id; ?>" class="btn btn-primary"><i class="ti-eye"></i></a>
	                                    ...
	                                    <td align="center">
	                                    	...
	                                    	<?php else: ?>
		                                    	<a href="<?php echo base_url(); ?>teacher/practice/grammer_del/<?php echo $row->grammer_test_id; ?>" class="btn btn-danger"><i class="ti-trash"></i></a>
		                                    <?php endif; ?>
	                                    </td>
	                                </tr>
	                            <?php endforeach; ?>
...
<div id="create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>teacher/practice/grammer_add/<?php echo $this->uri->segment(4); ?>" method="post" novalidate> 
