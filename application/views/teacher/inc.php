...
<head>
    ...
    <!-- Highlight Chart -->
    <script src="<?php echo base_url(); ?>assets/node_modules/highcharts/highcharts.src.js"></script>
    <script src="<?php echo base_url(); ?>assets/node_modules/highcharts/exporting.js"></script>
    <script src="<?php echo base_url(); ?>assets/node_modules/highcharts/export-data.js"></script>
                    ...
                    <ul id="sidebarnav">
                        <li class="user-pro"> 
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <b>Hi, <?php echo substr($this->session->userdata('__ci_teachername'),0,10); ?></b><br>
                                <span class="badge badge-info float-left mt-2">Teacher</span>
                                <div class="clearfix"></div>
                            </a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>teacher/profil"><i class="ti-user"></i> Profil</a></li>
                                <li><a href="<?php echo base_url(); ?>session/auth/logout"><i class="ti-shift-right-alt"></i> Logout</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/dashboard"><i class="ti-layout-grid2"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/group"><i class="ti-layout-grid2"></i><span class="hide-menu">Group</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/practice"><i class="ti-pencil"></i><span class="hide-menu">Practice room</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/test"><i class="ti-alarm-clock"></i><span class="hide-menu">Test room</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/competition"><i class="ti-medall"></i><span class="hide-menu">Competition room</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/library"><i class="icon-notebook"></i><span class="hide-menu">Library</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>teacher/media"><i class="icon-picture"></i><span class="hide-menu">Media</span></a>
                        </li>
                    </ul>
                </nav>
