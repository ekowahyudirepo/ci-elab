		    ...
		    <div class="card">
		        <div class="d-flex flex-row">
		            <div class="p-10 bg-info p-4 text-center" style="width: 100%;">
		                <h1 class="text-white box m-b-0"><i class="fa fa-book"></i><br> Reading</h1>

		            </div>
		            <div class="align-self-center text-center" style="width: 100%;">

		            	<?php if( $this->test_table == 'reading' ): ?>
		            		<?php if( $this->test_status == 'true' ): ?>
		            			<span class="badge badge-success blink">Active</span><br>
		            		<?php endif; ?>
		            	<?php endif; ?>
		            	
		            	<a class="btn btn-primary m-3" href="<?php echo base_url(); ?>student/test/reading">Course</a>
		            </div>
		        </div>
		    </div>
		</div>
		    ...
		    <div class="card">
		        <div class="d-flex flex-row">
		            ...
		            <div class="align-self-center text-center" style="width: 100%;">
		            	...
		            	<?php if( $this->test_table == 'grammer' ): ?>
		            		<?php if( $this->test_status == 'true' ): ?>
		            			<span class="badge badge-success blink">Active</span><br>
		            		<?php endif; ?>
		            	<?php endif; ?>

		            	<a class="btn btn-primary m-3" href="<?php echo base_url(); ?>student/test/grammer">Course</a>
		            </div>
		        </div>
		    </div>
		</div>
		    ...
		    <div class="card">
		        <div class="d-flex flex-row">
		            ...
		            <div class="align-self-center text-center" style="width: 100%;">
		            	...
		            	<?php if( $this->test_table == 'listening' ): ?>
		            		<?php if( $this->test_status == 'true' ): ?>
		            			<span class="badge badge-success blink">Active</span><br>
		            		<?php endif; ?>
		            	<?php endif; ?>

		            	<a class="btn btn-primary m-3" href="<?php echo base_url(); ?>student/test/listening">Course</a>
		            </div>
		        </div>
		    </div>
		</div>
		    ...
		    <div class="card">
		        <div class="d-flex flex-row">
		            ...
		            <div class="align-self-center text-center" style="width: 100%;">
		            	...
		            	<?php if( $this->test_table == 'speaking' ): ?>
		            		<?php if( $this->test_status == 'true' ): ?>
		            			<span class="badge badge-success blink">Active</span><br>
		            		<?php endif; ?>
		            	<?php endif; ?>

		            	<a class="btn btn-primary m-3" href="<?php echo base_url(); ?>student/test/speaking">Course</a>
		            </div>
		        </div>
		    </div>
		</div>
