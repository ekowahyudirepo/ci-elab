...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><button onclick="window.location = '<?php echo base_url(); ?>student/practice/reading'" class="btn btn-light d-none d-lg-block m-l-15"><i class="fa fa-arrow-left"></i> Back</button></h4>
    </div>
    ...
    <div class="col-12">
        ...
        <?php else : ?>
            <div class="card">
                ...
                <?php $no = 1; ?>
                <?php $i  = -1; ?>
                <?php foreach( $qw_reading_sub_test->result() as $row ): $i++; ?>
                <div class="card-body 

                <?php 


                    echo ( $qw_answer[$i] == $row->reading_sub_test_answer )? '' : 'bg-warning';
                ...
                ">   
                    <div class="row">
                        <div class="col-12">
                            ...
                            <!-- Block Question 1 -->
                            <p><?php echo $no++; ?>. <?php echo $row->reading_sub_test_question; ?> <b>Point (<?php echo $row->reading_sub_test_point; ?>) Correct answer is <?php echo $row->reading_sub_test_answer; ?></b></p>
                            <div class="form-group">
                                <input type="radio" class="check" id="flat-radio-1" name="choose<?php echo $row->reading_sub_test_id; ?>" data-radio="iradio_flat-red" 
