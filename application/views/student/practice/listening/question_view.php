...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor"><button onclick="window.location = '<?php echo base_url(); ?>student/practice/listening'" class="btn btn-light d-none d-lg-block m-l-15"><i class="fa fa-arrow-left"></i> Back</button></h4>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <!-- Block Question 1 -->
                            <p><?php echo $no++; ?>. <?php echo $row->listening_sub_test_question; ?> <b>Point (<?php echo $row->listening_sub_test_point; ?>)</b></p>
                            <div class="form-group">
                                <input type="radio" class="check" id="flat-radio-1" name="choose<?php echo $row->listening_sub_test_id; ?>" data-radio="iradio_flat-red" value="A" >
                                <label for="flat-radio-1">A. <?php echo $row->listening_sub_test_a; ?></label></br>
                                
                                <input type="radio" class="check" id="flat-radio-1" name="choose<?php echo $row->listening_sub_test_id; ?>" data-radio="iradio_flat-red" value="B" >
                                <label for="flat-radio-1">B. <?php echo $row->listening_sub_test_b; ?></label></br>
                                
                                <input type="radio" class="check" id="flat-radio-1" name="choose<?php echo $row->listening_sub_test_id; ?>" data-radio="iradio_flat-red" value="C" >
                                <label for="flat-radio-1">C. <?php echo $row->listening_sub_test_c; ?></label></br>
                                
                                <input type="radio" class="check" id="flat-radio-1" name="choose<?php echo $row->listening_sub_test_id; ?>" data-radio="iradio_flat-red" value="D" >
