...
<head>
    ...
    <script src='<?php echo base_url(); ?>assets/node_modules/calendar/dist/fullcalendar.min.js'></script>

    <?php endif; ?>

    <!-- Recoder Js -->
    <script src="<?php echo base_url(); ?>assets/node_modules/recorder/recorder.js"></script>
...
<body class="skin-megna fixed-layout">
    <?php if( $this->test_status == 'true' ): ?>
        <div class="countdown bg-dark text-white">
            <b id="hours">loading..</b>
            <b id="minutes"></b>
            <b id="seconds"></b>
            <br>
            <a href="<?php echo $this->test_link; ?>">View test</a>
        </div>
    <?php endif; ?>
                    ...
                    <ul id="sidebarnav">
                        <li class="user-pro"> 
                            <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                ...
                                <b>Hi, <?php echo substr($this->session->userdata('__ci_studentname'),0,10); ?></b><br>
                                <span class="badge badge-info float-left mt-2">Student</span>
                                <span class="badge badge-success float-left mt-2 ml-1"><?php echo $this->session->userdata('__ci_studentlevel'); ?></span>
                                <div class="clearfix"></div>
                            </a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>student/profil"><i class="ti-user"></i> Profil</a></li>
                                <li><a href="<?php echo base_url(); ?>session/auth/logout"><i class="ti-shift-right-alt"></i> Logout</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>student/dashboard"><i class="ti-layout-grid2"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>student/practice"><i class="ti-pencil"></i><span class="hide-menu">Practice</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>student/test"><i class="ti-alarm-clock"></i><span class="hide-menu">Test</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="<?php echo base_url() ?>student/library"><i class="icon-notebook"></i><span class="hide-menu">Library</span></a>
                        </li>
                    </ul>
                </nav>
    ...
    <script>
        ...
        let countDown = new Date('<?php echo $this->test_finish; ?>').getTime(),
            x = setInterval(function() {
              ...
              if (distance < 0) {
               clearInterval(x);
                window.location = '<?php echo base_url(); ?>student/test/<?php echo $this->test_table; ?>_question_finish/<?php echo $this->test_id; ?>';
              }
