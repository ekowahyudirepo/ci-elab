...
<div class="row">
                            ...
                            <table id="myTable" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>contributor/library/del/<?php echo $row->library_id; ?>" class="btn btn-danger"><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <div class="col-md-4">
        <div class="list-group">
            ...
            <a href="<?php echo base_url(); ?>contributor/library/index/reading" class="list-group-item <?php echo ( $this->uri->segment(4) == 'reading' || $this->uri->segment(4) == '' )? 'active' : ''; ?>">Reading (<?php echo $qw_reading_num; ?>)</a> 
            <a href="<?php echo base_url(); ?>contributor/library/index/grammar" class="list-group-item <?php echo ( $this->uri->segment(4) == 'grammar' )? 'active' : ''; ?>">Grammar (<?php echo $qw_grammar_num; ?>)</a> 
            <a href="<?php echo base_url(); ?>contributor/library/index/listening" class="list-group-item <?php echo ( $this->uri->segment(4) == 'listening' )? 'active' : ''; ?>">Listening (<?php echo $qw_listening_num; ?>)</a> 
            <a href="<?php echo base_url(); ?>contributor/library/index/speaking" class="list-group-item <?php echo ( $this->uri->segment(4) == 'speaking' )? 'active' : ''; ?>">Speaking (<?php echo $qw_speaking_num; ?>)</a> 
        </div>
    </div>
</div>
...
<div id="create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>contributor/library/add/<?php echo ( $this->uri->segment(4) == '') ? 'reading ': $this->uri->segment(4); ?>" method="post" enctype="multipart/form-data" novalidate> 
